...
the Radiant party and the Dire party respectively. Then if there are n senators, the size of the 
...
you need to predict which party will finally announce the victory and make the change in the
